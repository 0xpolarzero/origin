export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von origin",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von origin wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das origin CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",

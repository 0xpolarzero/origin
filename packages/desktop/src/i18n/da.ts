export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af origin",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af origin er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.menu.help.documentation": "origin Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "origin CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",

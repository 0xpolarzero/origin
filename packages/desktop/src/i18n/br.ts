export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do origin",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do origin foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do origin",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do origin está ausente. Tente reinstalar o aplicativo de desktop.",

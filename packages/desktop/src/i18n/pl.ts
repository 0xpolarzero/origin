export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji origin",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} origin. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.menu.help.documentation": "Dokumentacja origin",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego origin CLI. Spróbuj ponownie zainstalować aplikację na komputer.",

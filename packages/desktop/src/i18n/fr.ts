export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'origin",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'origin a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.menu.help.documentation": "Documentation d'origin",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI origin est manquant. Essayez de réinstaller l'application de bureau.",

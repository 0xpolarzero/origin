export const dict = {
  ...
  "desktop.menu.help.documentation": "origin Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of origin",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of origin has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.error.sidecarMissing": "origin CLI binary is missing. Try reinstalling the desktop app.",

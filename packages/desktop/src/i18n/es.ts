export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de origin",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de origin. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de origin",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de origin. Intenta reinstalar la aplicación de escritorio.",

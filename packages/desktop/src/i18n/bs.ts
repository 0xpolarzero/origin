export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju origin-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} origin-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.menu.help.documentation": "origin Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka origin CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",

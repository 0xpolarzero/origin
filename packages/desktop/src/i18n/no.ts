export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av origin",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av origin er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "origin Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "origin CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",

export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من origin",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من origin، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق origin",
  ...
  "desktop.cli.error.sidecarMissing": "ملف origin CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
